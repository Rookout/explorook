...
gsutil acl ch -u AllUsers:R "gs://${BUCKET}/explorook/mac/${MAC_DMG_NO_SPACE_FILE_NAME}"
gsutil cp "${INSTALLERS_DIR}${MAC_ARM64_DMG_FILE_NAME}" "gs://${BUCKET}/explorook/mac/${MAC_ARM64_DMG_NO_SPACE_FILE_NAME}"
gsutil acl ch -u AllUsers:R "gs://${BUCKET}/explorook/mac/${MAC_ARM64_DMG_NO_SPACE_FILE_NAME}"
...
gsutil acl ch -u AllUsers:R "gs://${BUCKET}/explorook/linux/${LINUX_NO_SPACE_FILE_NAME}"

gsutil cp "${INSTALLERS_DIR}${LINUX_ARM64_FILE_NAME}" "gs://${BUCKET}/explorook/linux/${LINUX_ARM64_NO_SPACE_FILE_NAME}"
gsutil acl ch -u AllUsers:R "gs://${BUCKET}/explorook/linux/${LINUX_ARM64_NO_SPACE_FILE_NAME}"
